...
import cyStyle from "../mainPanel/networkCanvas/cyStyle.json";
import data from "../mainPanel/networkCanvas/data.json";
...
export default function Code() {
  ...
  return <div ref={el} style={{ width: "100vw", height: "100vh" }} />;
}
